...
export declare const Markdown: ({ children, ...props }: MarkdownProps) => React.JSX.Element;
export declare const LastDirectChildNoMargin: import("styled-components").IStyledComponent<"web", {
