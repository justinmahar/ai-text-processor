...
export const defaultPresets: Preset[] = [
  ...
  },
  {
    ...
    aiModel: 'gpt-3.5-turbo',
    systemPrompt: 'You are a helpful assistant.',
    userPrompt: 'In {{Num_Paragraphs}} paragraphs or less, provide a concise summary of the following:',
    averageTokenLength: 4.5,
    requestMaxTokenRatio: 0.7,
    chunkOverlapWordCount: 20,
    chunkPrefix: '(continued...) ',
    autoShrink: false,
    variableValues: { '{{Num_Paragraphs}}': '1' },
    variableOptions: { '{{Num_Paragraphs}}': ['1', '2', '3', '4', '5'] },
  },
  {
    name: 'Translate Text',
    aiModel: 'gpt-3.5-turbo',
